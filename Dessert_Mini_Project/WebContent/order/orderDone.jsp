...
%>
	...
	<tr>
		<td class="td_default" align="center"><b><%= order.getOrderName() %></b> 님의 주문이
			안전하게 처리되었습니다.</td>
	</tr>
		...
		<td>
			<table width="100%" border="1" style="border-collapse: collapse"
				...
				<tr>
					...
					<td class="td_default" height="35"> <%= order.getOrderName() %>고객님</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="td_default" height="35"> <%= order.getPhone() %></td>
				</tr>
			</table>
	</tr>
	</td>
